...
(function () {
  ...
  function renderHero() {
    ...
    for (let i = 0; i < HEART_COUNT; i += 1) {
      ...
      hearts.push(
        ...
        `animation-delay:${delay}s;animation-duration:${duration}s;--ho:${peakOpacity};--dx:${drift}px;"></span>`
      );
    }
  ...
  function renderSteps() {
    const steps = [
      { n: '1', title: s('how1Title'), desc: s('how1Desc') },
      { n: '2', title: s('how2Title'), desc: s('how2Desc') },
      { n: '3', title: s('how3Title'), desc: s('how3Desc') }
    ];
    return `
